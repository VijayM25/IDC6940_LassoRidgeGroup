...
-   Source: SEER Registry, Breast Cancer Cases (2018–2022)
...
-   Ctegorized into three groups: treatment variables, tumor characteristics, and patient demographics. Treatment outcomes (radiation, chemotherapy) were derived from SEER treatment summary fields and were recoded into binary 0/1 outcomes indicating whether treatment was administered.
-   Tumor characteristics included tumor size (continuous), summary stage, nodal involvement (N0–N3), metastatic spread (bone/brain/liver/lung/lymph nodes), grade, laterality, and ER/PR/HER2 status. Each variable was cleaned, recoded, and mapped into clinically meaningful categories.
...
-  OLS regression has low bias, but it is also prone to overfitting and thus high variance. LASSO regression remedies this by introducing a shrinkage parameter, denoted as 𝜆. By shrinking the parameters, we introduce some bias but at the benefit of much lower variance.
...
-   Predictor matrices were fit across a grid of λ penalty values using glmnet with alpha = 1, allowing automatic variable selection through coefficient shrinkage.
-   Ten-fold cross-validation (cv.glmnet) was used to determine the λ that minimized prediction error, ensuring an optimal balance of model complexity and stability.
...
-   **Process:** 
      Clean & encode data – Standardize predictors – Cross-validation to select λ – 
      Fit final Lasso model – Extract non-zero coefficients

<img src="radi.png" width="500">  <img src="chem.png" width="500"> 

## Results - Radiation Model {.smaller}
<style>
...
## Results - Chemotherapy Model {.smaller}
...
-   Ten-fold cross-validation was used to select the optimal λ penalty for each model, ensuring stability and generalizability across diverse patient populations.
...
<div class="myDiv"><p>
Adamo M., Dickie L., & Ruhl, J. (2018). SEER Program Coding and Staging Manual 2018. National Cancer Institute.<BR><BR>
Ali, Shahzad, H. 2023. “Application and Impact of Lasso Regression in Gastroenterology.” A Systematic Review. Indian J Gastroenterol 42, 780–790 (2023).<BR><BR>
Li, Bai, Y. 2023. “Prognostic Nomograms for Gastric Carcinoma After D2 + Total Gastrectomy to Assist Decision-Making for Postoperative Treatment: Based on Lasso Regression.” World Journal of Surgical Oncology, 21(1), Article 207.<BR><BR>
Muthukrishnan, R., and R. Rohini. 2016. “LASSO: A Feature Selection Technique in Predictive Modeling for Machine Learning.” IEEE International Conference on Advances in Computer Applications (ICACA), Coimbatore, India, 2016, Pp. 18-20.<BR><BR>
Tibshirani, Robert. 1996. “Regression Shrinkage and Selection Via the Lasso.” Journal of the Royal Statistical Society: Series B (Methodological), Volume 58, Issue 1, January 1996, Pages 267–288.<BR><BR>
Vidaurre, Concha Bielza, Diego, and Pedro Larrañaga. 2013. “A Survey of L1 Regression.” International Statistical Review 81 (3): 361–87.
</p></div>
